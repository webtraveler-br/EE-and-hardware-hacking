# Módulo 5: Controle, Sinais e DSP

> **Sobre este módulo**: Este é o pilar mais abstrato e mais poderoso. Aqui você aprende a fazer **qualquer sistema** se comportar exatamente como deseja — temperatura, velocidade, posição, pressão. A ferramenta é a matemática (Laplace, Fourier, Bode), mas o resultado é profundamente prático.
>
...
>
> **Pré-requisitos**: [Módulo 0](../00-math-physics/README.md) Fases 2-3 (Cálculo I-II para Fourier), Fase 5 (EDOs e Laplace para modelagem), Fase 6 (álgebra linear para estabilidade). [Módulo 1](../01-circuits/README.md) completo (circuitos RC/RL/RLC como plantas). [Módulo 2](../02-electronics/README.md) e [Módulo 4](../04-power-industrial/README.md) recomendados (os sistemas a controlar vêm de lá).
>
> **Conexões com outros módulos**:
> - **Base de**: [Módulo 0](../00-math-physics/README.md) — Laplace (Mód 0.20), EDOs (Mód 0.18-0.19 → transitórios), integrais (Mód 0.11-0.14 → Fourier), autovalores (Mód 0.23 → estabilidade), probabilidade (Mód 0.24-0.25 → ruído/DSP)
> - **Plantas de**: [Módulo 1](../01-circuits/README.md) — RC/RL/RLC como sistemas a modelar. [Módulo 4](../04-power-industrial/README.md) — motor de indução como planta de controle de velocidade
> - **Implementação**: [Módulo 3](../03-digital-embedded/README.md) Módulos 3.10-3.11 (ADC/PWM para controle digital), [Módulo 6 L.19](../06-lab/README.md) Opção C (PID real com ESP32)
> - **Segurança**: [HH.7.1-7.3](../07-hardware-hacking/README.md) (side-channel = análise de sinais!), [HH Avançado E.1](../08-hardware-hacking-advanced/README.md) (matemática para SCA usa mesma base de correlação/estatística)
>
