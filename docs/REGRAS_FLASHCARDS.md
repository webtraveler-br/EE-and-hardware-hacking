...
- Dentro de MathJax, `\text{...}` apenas para **rótulo curto de variável** (ex: `hipotenusa`, `adjacente`, `cateto oposto`)
- Texto descritivo: sem LaTeX, em português
- Explicações/narrativa devem ficar fora de MathJax
...
- [ ] Delimitadores LaTeX em pares (`$...$` ou `$$...$$`)
