# Módulo 2: Eletrônica Analógica e de Potência

> **Sobre este módulo**: Semicondutores são os "músculos" da eletrônica — amplificam, retificam, chaveiam e convertem energia. Aqui você vai de componentes passivos a circuitos que criam, não apenas consomem.
>
...
- **Flyback (proteção de indutor)**: diodo em antiparalelo com bobinas/relés (já visto no Módulo 1!)
...
#### Checkpoint Final — Módulo 2 Completo!
...
> **Próximo passo**: [Módulo 3 — Sistemas Digitais e Microcontrolados](../03-digital-embedded/README.md)
