...
|------|---------|------|-----------|
| **0 — Setup** | 7.1–7.3 | Ambiente, ferramentas, mindset, representações numéricas | ~6h |
| **1 — Fundamentos** | 7.4–7.8 | Eletrônica, protocolos, Linux embarcado | ~11h |
| **2 — Reconhecimento** | 7.9–7.11 | OSINT, PCB, datasheets, mapeamento | ~7h |
| **3 — Interfaces Seriais** | 7.12–7.15 | UART, SPI, I2C, U-Boot, prática | ~12h |
| **4 — Debug & JTAG** | 7.16–7.18 | JTAG, SWD, exploração | ~5.5h |
| **5 — Firmware** | 7.19–7.22 | Extração, análise, emulação, exploit, web IoT | ~14h |
| **6 — Wireless** | 7.23–7.25 | RF, BLE, Wi-Fi/Zigbee | ~6h |
| **7 — Ataques Avançados** | 7.26–7.29 | Side-channel, fault injection, glitching | ~8h |
| **8 — Integração & Projetos** | 7.30–7.31 | Projetos completos, CTFs, portfólio | ~8h |
| | | **Total estimado** | **~77h** |
...
|--------|------|----------|
| 7.01 | Lab, Mindset e Superfícies de Ataque | ❄️ Cold Start OK |
| 7.02 | Python para Hardware Hacking | ❄️ Cold Start OK |
| 7.03 | Endianness e Representação de Dados | ❄️ Cold Start OK |
| 7.04 | Eletrônica, Equipamento e Solda | ❄️ Cold Start OK |
| 7.05 | Arquitetura de Sistemas Embarcados | 🔶 Projeto Ponte — fazer projeto ANTES dos cards |
| 7.06 | Protocolos Seriais — Contexto HH | ❄️ Cold Start OK |
| 7.07 | Linux Embarcado | ❄️ Cold Start OK |
| 7.08 | Leitura de Datasheets | ❄️ Cold Start OK |
| 7.09 | OSINT para Dispositivos IoT | ❄️ Cold Start OK |
| 7.10 | Análise Visual de PCB | ❄️ Cold Start OK |
| 7.11 | Identificação UART e Mapeamento | ❄️ Cold Start OK |
| 7.12 | Exploração UART na Prática | ❄️ Cold Start OK |
| 7.13 | Dump de Flash SPI | ❄️ Cold Start OK |
| 7.14 | EEPROM I2C e Attack Chain | ❄️ Cold Start OK |
| 7.15 | U-Boot e Bootloaders | ❄️ Cold Start OK |
| 7.16 | JTAG — Teoria e Identificação | 🔶 Projeto Ponte — fazer projeto ANTES dos cards |
| 7.17 | Exploração via JTAG/SWD | 🔶 Projeto Ponte — fazer projeto ANTES dos cards |
| 7.18 | Proteções de Debug e Bypass | 🔶 Projeto Ponte — fazer projeto ANTES dos cards |
| 7.19 | Extração e Descompressão de Firmware | ❄️ Cold Start OK |
| 7.20 | Análise Estática e Emulação de Firmware | 🔶 Projeto Ponte — fazer projeto ANTES dos cards |
| 7.21 | Modificação e Firmware Criptografado | 🔶 Projeto Ponte — fazer projeto ANTES dos cards |
| 7.22 | Hacking de Interfaces Web IoT | ❄️ Cold Start OK |
| 7.23 | Fundamentos de RF e SDR | 🔶 Projeto Ponte — fazer projeto ANTES dos cards |
| 7.24 | BLE Hacking | 🔶 Projeto Ponte — fazer projeto ANTES dos cards |
| 7.25 | Wi-Fi e Zigbee para IoT | 🔶 Projeto Ponte — fazer projeto ANTES dos cards |
| 7.26 | Side-Channel Attacks — Teoria | 🔶 Projeto Ponte — fazer projeto ANTES dos cards |
| 7.27 | Fault Injection | 🔶 Projeto Ponte — fazer projeto ANTES dos cards |
| 7.28 | Power Analysis com ChipWhisperer | 🔶 Projeto Ponte — fazer projeto ANTES dos cards |
| 7.29 | Ataques Físicos e Chip-Off | 🔶 Projeto Ponte — fazer projeto ANTES dos cards |
| 7.30 | Metodologia de Pentest IoT | ❄️ Cold Start OK |
| 7.31 | CTF e Portfólio | ❄️ Cold Start OK |
...
### Módulo 7.1: Configuração do Lab Virtual
**Tempo: 1h–1.5h**
...
#### Parte B: Introdução ao Mindset de Hardware Hacking
...
### Módulo 7.2: Python para Hardware Hacking
**Tempo: 2h**
...
### Módulo 7.3: Sistemas Numéricos, Endianness e Representação de Dados
**Tempo: 1.5h**
...
## Fase 1 — Fundamentos de Eletrônica e Sistemas Embarcados

### Módulo 7.4: Eletrônica Digital Essencial
**Tempo: 2h**
...
#### Parte B: Solda e Manipulação Física (Simulado)
...
### Módulo 7.5: Arquitetura de Sistemas Embarcados
**Tempo: 2h**
...
### Módulo 7.6: Protocolos de Comunicação Serial — Teoria
**Tempo: 1.5h**
...
### Módulo 7.7: Linux para Sistemas Embarcados
**Tempo: 2h**
...
### Módulo 7.8: Introdução a Datasheets com Auxílio de IA
**Tempo: 1.5h**
...
## Fase 2 — Reconhecimento e Análise de PCB

### Módulo 7.9: OSINT para Dispositivos IoT
**Tempo: 1.5h**
...
### Módulo 7.10: Análise Visual de PCB
**Tempo: 2h**
...
### Módulo 7.11: Identificação de Pinos e Interfaces com Multímetro (Simulado)
**Tempo: 1.5h**
...
#### Parte B: Mapeamento Completo de um Alvo
...
1. Escolha o alvo mais promissor do Módulo 7.9
...
## Fase 3 — Interfaces Seriais: Ataque e Exploração

### Módulo 7.12: Exploração UART na Prática
**Tempo: 2h**
...
### Módulo 7.14: Leitura e Escrita I2C EEPROM
**Tempo: 1.5h**
...
#### Parte B: Projeto Integrado — Full Serial Attack Chain
...
### Módulo 7.15: Interação com U-Boot e Bootloaders
**Tempo: 2h**
...
## Fase 4 — Debug Interfaces: JTAG e SWD

### Módulo 7.16: JTAG — Teoria e Identificação
**Tempo: 2h**
...
### Módulo 7.17: Exploração via JTAG/SWD
**Tempo: 2h**
...
### Módulo 7.18: Proteções e Bypass
**Tempo: 1.5h**
...
## Fase 5 — Firmware: Extração, Análise e Exploração

### Módulo 7.19: Extração e Descompressão de Firmware
**Tempo: 2h**
...
### Módulo 7.20: Análise Estática com Ghidra
**Tempo: 2.5h**
...
#### Parte B: Emulação de Firmware com QEMU
...
### Módulo 7.21: Modificação e Reempacotamento de Firmware
**Tempo: 2h**
...
#### Parte B: Análise de Firmware Criptografado
...
### Módulo 7.22: Hacking de Interfaces Web e APIs de IoT
**Tempo: 2h**
...
## Fase 6 — Wireless Hacking para IoT

### Módulo 7.23: Fundamentos de RF e SDR
**Tempo: 2h**
...
### Módulo 7.24: Bluetooth Low Energy (BLE) Hacking
**Tempo: 2h**
...
### Módulo 7.25: Wi-Fi e Zigbee para IoT
**Tempo: 2h**
...
## Fase 7 — Ataques Avançados de Hardware

### Módulo 7.26: Side-Channel Attacks — Teoria
**Tempo: 2h**
...
### Módulo 7.27: Fault Injection — Teoria e Simulação
**Tempo: 2h**
...
### Módulo 7.28: Power Analysis com ChipWhisperer
**Tempo: 2.5h**
...
### Módulo 7.29: Ataques Físicos e Chip-Off
**Tempo: 1.5h**
...
## Fase 8 — Integração, Projetos Capstone e Portfólio

### Módulo 7.30: Projeto Capstone — Full IoT Pentest
...
#### Parte B: Construção de Portfólio e Próximos Passos
...
| "Não sei por onde começar um pentest" | Siga o checklist do Módulo 7.11. Sempre comece por OSINT → firmware → interfaces |
