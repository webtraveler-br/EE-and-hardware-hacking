# Módulo 4: Eletrotécnica e Automação Industrial

> **Sobre este módulo**: Aqui a engenharia sai do laboratório e vai para a **fábrica e a subestação**. Motores de centenas de HP, sistemas trifásicos, proteção que salva vidas, e CLPs que controlam linhas de produção inteiras.
>
...
#### Checkpoint Final — Módulo 4 Completo!
...
> **Próximo passo**: [Módulo 5 — Controle e Sinais](../05-control-dsp/README.md)
...
> **SEGURANÇA**: Nunca trabalhe em circuitos trifásicos energizados. Tensões de 380V+ são LETAIS. Sempre desligue, teste ausência de tensão, aterre, e sinalize antes de qualquer intervenção.
