# Módulo 8: Hardware Hacking Avançado

> **Pré-requisito**: Ter completado (ou ter nível equivalente) o [Roadmap Básico](../07-hardware-hacking/README.md). Este roadmap assume que você já domina UART/SPI/I2C, sabe extrair e analisar firmware, consegue usar Ghidra, e tem prática com QEMU e ChipWhisperer básico.

> **Sobre este módulo**: Aqui você sai de **operador de ferramentas** para **criador de ferramentas e pesquisador**. Os projetos são mais longos, a teoria é mais densa, e os resultados são publicáveis. Esse é o caminho de quem descobre zero-days, publica em BlackHat, e é contratado para auditar silício.

> **Conexões com os Roadmaps de Engenharia Elétrica**:
> Este roadmap avançado é onde os [roadmaps de EE](../README.md) se tornam diferenciais críticos:
> - **Fase A (FPGA)**: [Módulo 3](../03-digital-embedded/README.md) Mód 3.1-3.8 (lógica digital/FSMs → base para Verilog), [Módulo 2](../02-electronics/README.md) Mód 2.7 (MOSFET → circuito crowbar do glitcher)
> - **Fase B (Barramentos)**: [Módulo 2](../02-electronics/README.md) Mód 2.17-2.18 (linhas de transmissão, impedância → integridade de sinal), [Módulo 0](../00-math-physics/README.md) Mód 0.34 (ondas EM → propagação em trilhas)
> - **Fase C (Silício)**: [Módulo 0](../00-math-physics/README.md) Mód 0.35-0.36 (semicondutores, junção PN → entender transistores no die), [Módulo 2](../02-electronics/README.md) Mód 2.1-2.7 (componentes → reconhecer em die shots)
> - **Fase E (Criptoanálise)**: [Módulo 0](../00-math-physics/README.md) Mód 0.24-0.25 (probabilidade, correlação → base de CPA), [Módulo 5](../05-control-dsp/README.md) Mód 5.3 e 5.13-5.16 (Fourier, DSP → análise de power traces)
> - **Fase F (OT/Automotive)**: [Módulo 4](../04-power-industrial/README.md) Mód 4.12-4.14 (CLPs, Ladder, sensores industriais → entender os sistemas sendo atacados), Mód 4.15-4.17 (sistemas de potência → contexto de infraestrutura crítica)
